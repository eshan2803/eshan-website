...
def match_to_substations(node_data, geojson_path):
    ...
    # Embed the price date so the front-end can display it
    substations['price_date'] = now_pst.strftime('%Y-%m-%d')
...
if __name__ == "__main__":
    ...
    if local_zip and os.path.exists(local_zip):
        ...
        print("Fetching today's CAISO DAM data and updating GeoJSON...")
