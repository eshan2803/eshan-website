...
Saves output as lmp_norm_vs_headroom.png.
"""
...
ax.set_title("LMP Normalized by CA Gas Citygate Price vs Effective Headroom\nCAISO Hourly Data: Jan 2020 – Dec 2025",
...
out_path = os.path.join(script_dir, "lmp_norm_vs_headroom.png")
