"""
Improved 2-panel renewable energy penetration visualization (V2).

V2 changes:
- Renewables include battery discharge (stored solar)
- Demand excludes battery effect entirely
- Shows renewables + stored solar vs actual grid load
...
# Load hourly data
print("Loading hourly data (V2)...")
with open(os.path.join(script_dir, "renewable_penetration_hourly_v2.json")) as f:
    hourly_data = json.load(f)

# Load daily data
print("Loading daily data (V2)...")
with open(os.path.join(script_dir, "renewable_penetration_daily_v2.json")) as f:
...
ax1.set_title("California Grid: Hourly Renewable Energy Penetration V2 (2020-2025)\n"
...
ax2.set_title("Daily Hours with ≥100% Renewable Penetration (V2)\n"
...
# Save
print("Saving figure...")
out_path = os.path.join(script_dir, "renewable_penetration_improved_v2.png")
