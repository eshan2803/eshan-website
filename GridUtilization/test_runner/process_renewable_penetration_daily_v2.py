"""
Process CAISO fuel-source CSVs to calculate daily renewable energy penetration (V2).
...
Output daily statistics:
  - renewable_penetration_daily_v2.json  {
      "YYYY-MM-DD": {
...
OUT_FILE = os.path.join(os.path.dirname(__file__), "renewable_penetration_daily_v2.json")
...
print(f"\nSaved daily renewable penetration data (V2) to {OUT_FILE}")
