"""
Scatter plot: MEC (energy component of LMP) normalized by CA Natural Gas Citygate price vs Net Load.
...
Saves output as mec_norm_vs_netload.png.
"""
...
ax.set_title("MEC Normalized by CA Gas Citygate Price vs Net Load\nCAISO Hourly Data: Jan 2020 – Dec 2025",
...
out_path = os.path.join(script_dir, "mec_norm_vs_netload.png")
