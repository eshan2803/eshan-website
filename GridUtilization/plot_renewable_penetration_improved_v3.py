"""
Improved 2-panel clean energy penetration visualization (V3).
...
ax1.set_title("California Grid: Hourly Clean Energy Penetration\n"
              "(renewables + battery discharge + nuclear + large hydro)",
