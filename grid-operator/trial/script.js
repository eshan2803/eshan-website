...
function updateCurtailmentRanges(tick = 0) {
    ...
    solarCurtailmentMaxDisplay.textContent = `Max: ${maxSolarCurtailment.toLocaleString()} MW (this tick)`;
    ...
    windCurtailmentMaxDisplay.textContent = `Max: ${maxWindCurtailment.toLocaleString()} MW (this tick)`;
