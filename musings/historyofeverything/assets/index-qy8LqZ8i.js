...
`,I_={bigBangFlash:null,bigBangParticles:null,cmbSphere:null,galaxiesGroup:new tn,galaxy:null,bgGalaxies:[],solarSystem:new tn,earthGroup:new tn};I_.bigBangFlash=new kr(new gi(1,64,64),new _r({color:16777215,transparent:!0,opacity:0})),j_.add(I_.bigBangFlash);var L_=new or,R_=new Float32Array(3e4*3),z_=new Float32Array(3e4*3);for(let e=0;e<9e4;e+=3){R_[e]=0,R_[e+1]=0,R_[e+2]=0;let t=Math.random(),n=Math.random(),r=t*2*Math.PI,i=Math.acos(2*n-1),a=Math.random()*80+20;z_[e]=Math.sin(i)*Math.cos(r)*a,z_[e+1]=Math.sin(i)*Math.sin(r)*a,z_[e+2]=Math.cos(i)*a}L_.setAttribute(`position`,new Gn(R_,3)),L_.setAttribute(`velocity`,new Gn(z_,3));var B_=new ei({size:2,color:16772795,map:P_,transparent:!0,opacity:0,depthWrite:!1,blending:2});I_.bigBangParticles=new ai(L_,B_),j_.add(I_.bigBangParticles);var V_=(e,t)=>{let n=document.createElement(`video`);return n.id=e,n.src=t,n.crossOrigin=`anonymous`,n.loop=!0,n.muted=!0,n.volume=0,n.playsInline=!0,Object.assign(n.style,{position:`fixed`,top:`0`,left:`0`,width:`100vw`,height:`100vh`,objectFit:`cover`,zIndex:`-2`,opacity:`0`}),document.body.appendChild(n),n.load(),n.pause(),n},H_=V_(`cmb-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/cmb.mp4`),U_=V_(`galaxy-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/galaxy.mp4`),W_=V_(`solar-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/solar_system.mp4`),G_=V_(`hadean-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/hadean.mp4`),K_=V_(`rain-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/great_rain.mp4`),q_=V_(`life-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/first_life.mp4`),J_=V_(`oxygen-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/greatoxidation.mp4`),Y_=V_(`complex-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/complexlife.mp4`),X_=V_(`cambrian-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/cambrianexplosion.mp4`),Z_=[H_,U_,W_,G_,K_,q_,J_,Y_,X_],Q_={cmb:0,galaxy:0,solar:0,hadean:0,rain:0,life:0,oxygen:0,complex:0,cambrian:0},$_=2e3,ev=new gi($_,512,512),tv=new Ti({uniforms:{uTime:{value:0},uState:{value:0},uAsteroidImpact:{value:0},uImpactPos:{value:new Y(0,0,0)}},vertexShader:`
  ...
  `}),nv=new kr(ev,tv);nv.position.set(0,-$_-40,0),I_.earthGroup.add(nv);var rv=15e3,iv=new or,av=new Float32Array(rv*6);for(let e=0;e<rv;e++){let t=(Math.random()-.5)*600,n=Math.random()*200,r=(Math.random()-.5)*300-50;av[e*6]=t,av[e*6+1]=n,av[e*6+2]=r,av[e*6+3]=t,av[e*6+4]=n-8,av[e*6+5]=r}iv.setAttribute(`position`,new Gn(av,3));var ov=new Vr({color:8961023,transparent:!0,opacity:0,blending:2}),sv=new $r(iv,ov);I_.earthGroup.add(sv);var cv=new gi(3,32,32),lv=new Ti({uniforms:{uTime:{value:0},uOpacity:{value:0}},vertexShader:`varying vec3 vPos; void main() { vPos = position; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
  ...
  `,transparent:!0,blending:2}),uv=new kr(cv,lv),dv=new mi(4,40,32);dv.translate(0,20,0);var fv=new Ti({uniforms:{uTime:{value:0},uOpacity:{value:0}},vertexShader:`varying vec2 vUv; varying vec3 vPos; void main() { vUv = uv; vPos = position; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
  ...
  `,transparent:!0,blending:2,depthWrite:!1}),pv=new kr(dv,fv);pv.rotation.x=-Math.PI/2,uv.add(pv),I_.earthGroup.add(uv);var mv=new _r({color:16777215,transparent:!0,opacity:0,blending:2,depthWrite:!1}),hv=new kr(new hi(1e3,1e3),mv);hv.position.z=90,I_.earthGroup.add(hv),I_.earthGroup.visible=!1,j_.add(I_.earthGroup);var gv=0,_v=!1;Yp.set(O_,{opacity:0,y:50,visibility:`hidden`}),Yp.set(O_[0],{opacity:1,y:0,visibility:`visible`}),p_.create({trigger:`#scroll-proxy`,start:`top top`,end:`bottom bottom`,scrub:1,onUpdate:e=>{let t=e.progress*w_,n=0;for(let e=0;e<C_.length;e++)if(t>=C_[e].startBlock&&t<C_[e].startBlock+C_[e].blocks){n=e;break}t>=w_&&(n=C_.length-1),n!==gv&&(O_.forEach((e,t)=>{t!==n&&(Yp.killTweensOf(e),Yp.to(e,{opacity:0,y:-50,duration:.3,onComplete:()=>Yp.set(e,{visibility:`hidden`})}),k_[t].classList.remove(`active`))}),gv=n,Yp.killTweensOf(O_[gv]),Yp.set(O_[gv],{visibility:`visible`,y:50}),Yp.to(O_[gv],{opacity:1,y:0,duration:.5,delay:.2}),k_[gv].classList.add(`active`));let r=(t-C_[n].startBlock)/C_[n].blocks,i=t;if(H_.readyState>=1&&H_.duration&&(Q_.cmb=Math.max(0,Math.min(1,(i-2)/4))*H_.duration),U_.readyState>=1&&U_.duration&&(Q_.galaxy=Math.max(0,Math.min(1,(i-6)/4))*U_.duration),W_.readyState>=1&&W_.duration&&(Q_.solar=Math.max(0,Math.min(1,(i-10)/4))*W_.duration),G_.readyState>=1&&G_.duration&&(Q_.hadean=Math.max(0,Math.min(1,(i-14)/4))*G_.duration),K_.readyState>=1&&K_.duration&&(Q_.rain=Math.max(0,Math.min(1,(i-18)/4))*K_.duration),q_.readyState>=1&&q_.duration&&(Q_.life=Math.max(0,Math.min(1,(i-22)/4))*q_.duration),J_.readyState>=1&&J_.duration&&(Q_.oxygen=Math.max(0,Math.min(1,(i-26)/4))*J_.duration),Y_.readyState>=1&&Y_.duration&&(Q_.complex=Math.max(0,Math.min(1,(i-30)/4))*Y_.duration),X_.readyState>=1&&X_.duration&&(Q_.cambrian=Math.max(0,Math.min(1,(i-34)/4))*X_.duration),I_.earthGroup.visible=n>=11,I_.bigBangParticles.visible=n===1||n===2,I_.bigBangFlash.visible=n===1,n<11?(M_.position.set(0,0,100),M_.lookAt(0,0,0)):(M_.position.set(0,5,100),M_.lookAt(0,0,0)),n===0)_v=!1,B_.opacity=0,I_.bigBangFlash.material.opacity=0,Z_.forEach(e=>e.style.opacity=`0`),document.body.style.backgroundColor=`#000000`,j_.fog.color.setHex(0);else if(n===1){if(!_v){_v=!0;let e=L_.attributes.position.array;for(let t=0;t<e.length;t++)e[t]=0;L_.attributes.position.needsUpdate=!0}r<.15?(I_.bigBangFlash.scale.setScalar(r*600+1),I_.bigBangFlash.material.opacity=r*6):I_.bigBangFlash.material.opacity=Math.max(0,1-(r-.15)/.5),B_.opacity=r>.05?1-r:0,Z_.forEach(e=>e.style.opacity=`0`)}else if(n>=2&&n<11)Z_.forEach((e,t)=>{t===n-2?e.style.opacity=Math.min(1,r*4).toString():t===n-3?e.style.opacity=Math.max(0,1-r*4).toString():e.style.opacity=`0`});else if(n>=11){let e=0,t=new ln(0);if(tv.uniforms.uAsteroidImpact.value=0,hv.material.opacity=0,Z_.forEach((e,t)=>{n===11&&t===8?e.style.opacity=Math.max(0,1-r*4).toString():e.style.opacity=`0`}),n===11)e=3+r,t.lerpColors(new ln(1715004),new ln(4491519),Math.min(1,r*2));else if(n===12)e=4+r,t.setHex(4491519);else if(n===13)if(e=5+r,r>.3&&r<.6){lv.uniforms.uOpacity.value=1,fv.uniforms.uOpacity.value=1;let e=(r-.3)/.3;uv.position.set(100-e*100,100-e*100,-20),uv.lookAt(0,-10,-20),t.setHex(16755200)}else if(r>=.6){if(lv.uniforms.uOpacity.value=0,fv.uniforms.uOpacity.value=0,t.setHex(1115392),r<.65&&(hv.material.opacity=1-(r-.6)/.05,t.setHex(16777215)),r<.9){let e=(r-.6)/.3;tv.uniforms.uAsteroidImpact.value=e,tv.uniforms.uImpactPos.value.set(0,0,-20)}}else lv.uniforms.uOpacity.value=0,fv.uniforms.uOpacity.value=0,t.setHex(4491519);else n===14&&(e=6+r,t.lerpColors(new ln(1115392),new ln(131589),r));tv.uniforms.uState.value=e,document.body.style.backgroundColor=`#`+t.getHexString(),j_.fog.color.copy(t)}}});var vv=new xa;function yv(){requestAnimationFrame(yv);let e=vv.getDelta(),t=vv.getElapsedTime();if(_v&&B_.opacity>0){let t=L_.attributes.position.array,n=L_.attributes.velocity.array;for(let r=0;r<t.length;r+=3)t[r]+=n[r]*e,t[r+1]+=n[r+1]*e,t[r+2]+=n[r+2]*e;L_.attributes.position.needsUpdate=!0}if(!H_.seeking&&Math.abs(H_.currentTime-Q_.cmb)>.05&&(H_.currentTime=Q_.cmb),!U_.seeking&&Math.abs(U_.currentTime-Q_.galaxy)>.05&&(U_.currentTime=Q_.galaxy),!W_.seeking&&Math.abs(W_.currentTime-Q_.solar)>.05&&(W_.currentTime=Q_.solar),!G_.seeking&&Math.abs(G_.currentTime-Q_.hadean)>.05&&(G_.currentTime=Q_.hadean),!K_.seeking&&Math.abs(K_.currentTime-Q_.rain)>.05&&(K_.currentTime=Q_.rain),!q_.seeking&&Math.abs(q_.currentTime-Q_.life)>.05&&(q_.currentTime=Q_.life),!J_.seeking&&Math.abs(J_.currentTime-Q_.oxygen)>.05&&(J_.currentTime=Q_.oxygen),!Y_.seeking&&Math.abs(Y_.currentTime-Q_.complex)>.05&&(Y_.currentTime=Q_.complex),!X_.seeking&&Math.abs(X_.currentTime-Q_.cambrian)>.05&&(X_.currentTime=Q_.cambrian),I_.earthGroup.visible){if(nv.rotation.z=t*.02,tv.uniforms.uTime.value=t,ov.opacity>0){let t=iv.attributes.position.array;for(let n=0;n<rv;n++)t[n*6+1]-=300*e,t[n*6+4]-=300*e,t[n*6+1]<-50&&(t[n*6+1]=150+Math.random()*50,t[n*6+4]=t[n*6+1]-8);iv.attributes.position.needsUpdate=!0}lv.uniforms.uOpacity.value>0&&(lv.uniforms.uTime.value=t,fv.uniforms.uTime.value=t)}N_.render(j_,M_)}yv(),window.addEventListener(`resize`,()=>{M_.aspect=window.innerWidth/window.innerHeight,M_.updateProjectionMatrix(),N_.setSize(window.innerWidth,window.innerHeight),N_.setPixelRatio(Math.min(window.devicePixelRatio,2))});