...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(e,t,n){let r=new Float32Array(La),i=new Y(0,1,0);return new Ti({name:`SphericalGaussianBlur`,defines:{n:La,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new Ti({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new Ti({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
	...
	`}var to=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,I_={bigBangFlash:null,bigBangParticles:null,cmbSphere:null,galaxiesGroup:new tn,galaxy:null,bgGalaxies:[],solarSystem:new tn,earthGroup:new tn};I_.bigBangFlash=new kr(new gi(1,64,64),new _r({color:16777215,transparent:!0,opacity:0})),j_.add(I_.bigBangFlash);var L_=new or,R_=new Float32Array(3e4*3),z_=new Float32Array(3e4*3);for(let e=0;e<9e4;e+=3){R_[e]=0,R_[e+1]=0,R_[e+2]=0;let t=Math.random(),n=Math.random(),r=t*2*Math.PI,i=Math.acos(2*n-1),a=Math.random()*80+20;z_[e]=Math.sin(i)*Math.cos(r)*a,z_[e+1]=Math.sin(i)*Math.sin(r)*a,z_[e+2]=Math.cos(i)*a}L_.setAttribute(`position`,new Gn(R_,3)),L_.setAttribute(`velocity`,new Gn(z_,3));var B_=new ei({size:2,color:16772795,map:P_,transparent:!0,opacity:0,depthWrite:!1,blending:2});I_.bigBangParticles=new ai(L_,B_),j_.add(I_.bigBangParticles);var V_=(e,t)=>{let n=document.createElement(`video`);return n.id=e,n.src=t,n.crossOrigin=`anonymous`,n.loop=!0,n.muted=!0,n.volume=0,n.playsInline=!0,Object.assign(n.style,{position:`fixed`,top:`0`,left:`0`,width:`100vw`,height:`100vh`,objectFit:`cover`,zIndex:`-2`,opacity:`0`}),document.body.appendChild(n),n.load(),n.pause(),n},H_=V_(`cmb-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/cmb.mp4`),U_=V_(`galaxy-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/galaxy.mp4`),W_=V_(`solar-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/solar_system.mp4`),G_=V_(`hadean-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/hadean.mp4`),K_=V_(`rain-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/great_rain.mp4`),q_=V_(`life-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/first_life.mp4`),J_=V_(`oxygen-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/greatoxidation.mp4`),Y_=V_(`complex-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/complexlife.mp4`),X_=V_(`cambrian-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/cambrianexplosion.mp4`),Z_=V_(`land-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/conqueringland.mp4`),Q_=V_(`forests-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/riseofforests.mp4`),$_=V_(`vertebrates-video`,`https://pub-170eae4c8bc147fc842e785bd09533e3.r2.dev/firstvertebrates.mp4`),ev=[H_,U_,W_,G_,K_,q_,J_,Y_,X_,Z_,Q_,$_],tv={cmb:0,galaxy:0,solar:0,hadean:0,rain:0,life:0,oxygen:0,complex:0,cambrian:0,land:0,forests:0,vertebrates:0},nv=2e3,rv=new gi(nv,512,512),iv=new Ti({uniforms:{uTime:{value:0},uState:{value:0},uAsteroidImpact:{value:0},uImpactPos:{value:new Y(0,0,0)}},vertexShader:`
  ...
  `}),av=new kr(rv,iv);av.position.set(0,-nv-40,0),I_.earthGroup.add(av);var ov=15e3,sv=new or,cv=new Float32Array(ov*6);for(let e=0;e<ov;e++){let t=(Math.random()-.5)*600,n=Math.random()*200,r=(Math.random()-.5)*300-50;cv[e*6]=t,cv[e*6+1]=n,cv[e*6+2]=r,cv[e*6+3]=t,cv[e*6+4]=n-8,cv[e*6+5]=r}sv.setAttribute(`position`,new Gn(cv,3));var lv=new Vr({color:8961023,transparent:!0,opacity:0,blending:2}),uv=new $r(sv,lv);I_.earthGroup.add(uv);var dv=new gi(3,32,32),fv=new Ti({uniforms:{uTime:{value:0},uOpacity:{value:0}},vertexShader:`varying vec3 vPos; void main() { vPos = position; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
  ...
  `,transparent:!0,blending:2}),pv=new kr(dv,fv),mv=new mi(4,40,32);mv.translate(0,20,0);var hv=new Ti({uniforms:{uTime:{value:0},uOpacity:{value:0}},vertexShader:`varying vec2 vUv; varying vec3 vPos; void main() { vUv = uv; vPos = position; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
  ...
  `,transparent:!0,blending:2,depthWrite:!1}),gv=new kr(mv,hv);gv.rotation.x=-Math.PI/2,pv.add(gv),I_.earthGroup.add(pv);var _v=new _r({color:16777215,transparent:!0,opacity:0,blending:2,depthWrite:!1}),vv=new kr(new hi(1e3,1e3),_v);vv.position.z=90,I_.earthGroup.add(vv),I_.earthGroup.visible=!1,j_.add(I_.earthGroup);var yv=0,bv=!1;Yp.set(O_,{opacity:0,y:50,visibility:`hidden`}),Yp.set(O_[0],{opacity:1,y:0,visibility:`visible`}),p_.create({trigger:`#scroll-proxy`,start:`top top`,end:`bottom bottom`,scrub:1,onUpdate:e=>{let t=e.progress*w_,n=0;for(let e=0;e<C_.length;e++)if(t>=C_[e].startBlock&&t<C_[e].startBlock+C_[e].blocks){n=e;break}t>=w_&&(n=C_.length-1),n!==yv&&(O_.forEach((e,t)=>{t!==n&&(Yp.killTweensOf(e),Yp.to(e,{opacity:0,y:-50,duration:.3,onComplete:()=>Yp.set(e,{visibility:`hidden`})}),k_[t].classList.remove(`active`))}),yv=n,Yp.killTweensOf(O_[yv]),Yp.set(O_[yv],{visibility:`visible`,y:50}),Yp.to(O_[yv],{opacity:1,y:0,duration:.5,delay:.2}),k_[yv].classList.add(`active`));let r=(t-C_[n].startBlock)/C_[n].blocks,i=t;if(H_.readyState>=1&&H_.duration&&(tv.cmb=Math.max(0,Math.min(1,(i-2)/4))*H_.duration),U_.readyState>=1&&U_.duration&&(tv.galaxy=Math.max(0,Math.min(1,(i-6)/4))*U_.duration),W_.readyState>=1&&W_.duration&&(tv.solar=Math.max(0,Math.min(1,(i-10)/4))*W_.duration),G_.readyState>=1&&G_.duration&&(tv.hadean=Math.max(0,Math.min(1,(i-14)/4))*G_.duration),K_.readyState>=1&&K_.duration&&(tv.rain=Math.max(0,Math.min(1,(i-18)/4))*K_.duration),q_.readyState>=1&&q_.duration&&(tv.life=Math.max(0,Math.min(1,(i-22)/4))*q_.duration),J_.readyState>=1&&J_.duration&&(tv.oxygen=Math.max(0,Math.min(1,(i-26)/4))*J_.duration),Y_.readyState>=1&&Y_.duration&&(tv.complex=Math.max(0,Math.min(1,(i-30)/4))*Y_.duration),X_.readyState>=1&&X_.duration&&(tv.cambrian=Math.max(0,Math.min(1,(i-34)/4))*X_.duration),Z_.readyState>=1&&Z_.duration&&(tv.land=Math.max(0,Math.min(1,(i-38)/4))*Z_.duration),Q_.readyState>=1&&Q_.duration&&(tv.forests=Math.max(0,Math.min(1,(i-42)/4))*Q_.duration),$_.readyState>=1&&$_.duration&&(tv.vertebrates=Math.max(0,Math.min(1,(i-46)/4))*$_.duration),I_.earthGroup.visible=n>=14,I_.bigBangParticles.visible=n===1||n===2,I_.bigBangFlash.visible=n===1,n<14?(M_.position.set(0,0,100),M_.lookAt(0,0,0)):(M_.position.set(0,5,100),M_.lookAt(0,0,0)),n===0)bv=!1,B_.opacity=0,I_.bigBangFlash.material.opacity=0,ev.forEach(e=>e.style.opacity=`0`),document.body.style.backgroundColor=`#000000`,j_.fog.color.setHex(0);else if(n===1){if(!bv){bv=!0;let e=L_.attributes.position.array;for(let t=0;t<e.length;t++)e[t]=0;L_.attributes.position.needsUpdate=!0}r<.15?(I_.bigBangFlash.scale.setScalar(r*600+1),I_.bigBangFlash.material.opacity=r*6):I_.bigBangFlash.material.opacity=Math.max(0,1-(r-.15)/.5),B_.opacity=r>.05?1-r:0,ev.forEach(e=>e.style.opacity=`0`)}else if(n>=2&&n<14)ev.forEach((e,t)=>{t===n-2?e.style.opacity=Math.min(1,r*4).toString():t===n-3?e.style.opacity=Math.max(0,1-r*4).toString():e.style.opacity=`0`});else if(n>=14){let e=0,t=new ln(0);if(iv.uniforms.uAsteroidImpact.value=0,vv.material.opacity=0,ev.forEach((e,t)=>{n===14&&t===11?e.style.opacity=Math.max(0,1-r*4).toString():e.style.opacity=`0`}),n===14)e=4+r,t.lerpColors(new ln(1715004),new ln(4491519),Math.min(1,r*2));else if(n===15)if(e=5+r,r>.3&&r<.6){fv.uniforms.uOpacity.value=1,hv.uniforms.uOpacity.value=1;let e=(r-.3)/.3;pv.position.set(100-e*100,100-e*100,-20),pv.lookAt(0,-10,-20),t.setHex(16755200)}else if(r>=.6){if(fv.uniforms.uOpacity.value=0,hv.uniforms.uOpacity.value=0,t.setHex(1115392),r<.65&&(vv.material.opacity=1-(r-.6)/.05,t.setHex(16777215)),r<.9){let e=(r-.6)/.3;iv.uniforms.uAsteroidImpact.value=e,iv.uniforms.uImpactPos.value.set(0,0,-20)}}else fv.uniforms.uOpacity.value=0,hv.uniforms.uOpacity.value=0,t.setHex(4491519);else n===16&&(e=6+r,t.lerpColors(new ln(1115392),new ln(131589),r));iv.uniforms.uState.value=e,document.body.style.backgroundColor=`#`+t.getHexString(),j_.fog.color.copy(t)}}});var xv=new xa;function Sv(){requestAnimationFrame(Sv);let e=xv.getDelta(),t=xv.getElapsedTime();if(bv&&B_.opacity>0){let t=L_.attributes.position.array,n=L_.attributes.velocity.array;for(let r=0;r<t.length;r+=3)t[r]+=n[r]*e,t[r+1]+=n[r+1]*e,t[r+2]+=n[r+2]*e;L_.attributes.position.needsUpdate=!0}if(!H_.seeking&&Math.abs(H_.currentTime-tv.cmb)>.05&&(H_.currentTime=tv.cmb),!U_.seeking&&Math.abs(U_.currentTime-tv.galaxy)>.05&&(U_.currentTime=tv.galaxy),!W_.seeking&&Math.abs(W_.currentTime-tv.solar)>.05&&(W_.currentTime=tv.solar),!G_.seeking&&Math.abs(G_.currentTime-tv.hadean)>.05&&(G_.currentTime=tv.hadean),!K_.seeking&&Math.abs(K_.currentTime-tv.rain)>.05&&(K_.currentTime=tv.rain),!q_.seeking&&Math.abs(q_.currentTime-tv.life)>.05&&(q_.currentTime=tv.life),!J_.seeking&&Math.abs(J_.currentTime-tv.oxygen)>.05&&(J_.currentTime=tv.oxygen),!Y_.seeking&&Math.abs(Y_.currentTime-tv.complex)>.05&&(Y_.currentTime=tv.complex),!X_.seeking&&Math.abs(X_.currentTime-tv.cambrian)>.05&&(X_.currentTime=tv.cambrian),!Z_.seeking&&Math.abs(Z_.currentTime-tv.land)>.05&&(Z_.currentTime=tv.land),!Q_.seeking&&Math.abs(Q_.currentTime-tv.forests)>.05&&(Q_.currentTime=tv.forests),!$_.seeking&&Math.abs($_.currentTime-tv.vertebrates)>.05&&($_.currentTime=tv.vertebrates),I_.earthGroup.visible){if(av.rotation.z=t*.02,iv.uniforms.uTime.value=t,lv.opacity>0){let t=sv.attributes.position.array;for(let n=0;n<ov;n++)t[n*6+1]-=300*e,t[n*6+4]-=300*e,t[n*6+1]<-50&&(t[n*6+1]=150+Math.random()*50,t[n*6+4]=t[n*6+1]-8);sv.attributes.position.needsUpdate=!0}fv.uniforms.uOpacity.value>0&&(fv.uniforms.uTime.value=t,hv.uniforms.uTime.value=t)}N_.render(j_,M_)}Sv(),window.addEventListener(`resize`,()=>{M_.aspect=window.innerWidth/window.innerHeight,M_.updateProjectionMatrix(),N_.setSize(window.innerWidth,window.innerHeight),N_.setPixelRatio(Math.min(window.devicePixelRatio,2))});